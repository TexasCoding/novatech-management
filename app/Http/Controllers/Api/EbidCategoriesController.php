...
use App\EbidCategory;
use App\Http\Resources\EbidCategoryResource;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class EbidCategoriesController extends Controller
{
    public function index()
    {
        return EbidCategoryResource::collection(EbidCategory::all());
    }
    ...
    public function create(Request $request)
    {
        ...
        for ($i = 0; $i < count($categoryArray); $i++) {
            ...
            try {
                $category = EbidCategory::firstOrCreate($newCategory);
